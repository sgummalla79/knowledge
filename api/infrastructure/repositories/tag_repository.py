...
from api.domain.entities import Tag as TagEntity
from api.domain.errors import ConflictError
from api.infrastructure.orm import DocumentTag as DocumentTagModel
from api.infrastructure.orm import Tag as TagModel
