...
def test_embed_documents_prefixes_and_posts_input():
    ...
    with patch("api.infrastructure.embeddings.ollama_provider.requests.post") as mock_post:
...
def test_list_models_returns_model_names():
    ...
    with patch("api.infrastructure.embeddings.ollama_provider.requests.get") as mock_get:
