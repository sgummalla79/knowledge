...
class OrganizationRepositoryPort(Protocol):
    ...
    def update_name(self, org_id: UUID, name: str) -> Organization: ...
...
class TagRepositoryPort(Protocol):
    ...
    def find_by_name_ci(self, org_id: UUID, name: str) -> Tag | None: ...
...
class IdentityRepositoryPort(Protocol):
    ...
    def create(
        self, username: str, password_hash: str, *, name: str, email: str | None = None, must_change_password: bool = True
    ) -> Identity: ...
...
class PersonalAccessTokenRepositoryPort(Protocol):
    ...
    def get_by_token_hash(self, token_hash: str) -> PersonalAccessToken | None: ...

    def get_by_id(self, token_id: UUID) -> PersonalAccessToken | None: ...

    def list_for_identity_in_org(self, identity_id: UUID, org_id: UUID) -> list[PersonalAccessToken]: ...
...
class ProfileRepositoryPort(Protocol):
    def create(self, org_id: UUID, name: str, *, is_admin: bool = False, is_system: bool = False, **fields) -> Profile: ...

    def get(self, profile_id: UUID) -> Profile | None: ...

    def get_admin_profile(self, org_id: UUID) -> Profile | None: ...

    def get_by_name(self, org_id: UUID, name: str) -> Profile | None: ...
