...
from api.mcp_server.tools import rag as rag_tools
...
# /mcp/rag, /mcp/read, /mcp/write by api/asgi.py — see build_asgi_app's lifespan handling for why
# each server's session_manager needs to be entered there, not here.
_TIERS = {
    "rag": (rag_tools, "Search and browse a connected org's knowledge base."),
