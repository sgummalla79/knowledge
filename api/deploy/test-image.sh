...
# ("knowledge"), colliding with other local compose stacks (e.g. dev-preview) and making them look
# like orphans of *this* project. A distinct name keeps every stack unambiguously separate.
...
"$PYTHON" -m pytest tests/ mcp_server/tests/ ingestion_worker/tests/
