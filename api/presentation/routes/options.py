...
from api.presentation.schemas import EmbeddingModelListRequest
...
def get_embedding_options():
    statuses = _embedding_provider_config_service().list_status(g.org_id)
    ...
    return jsonify(
        {
            ...
            "providers": [
                {
                    ...
                    # Single source of truth is api/constants.py, so a new provider needs an entry
            ...
            # Convenience suggestions only, never validated/enforced — see api/constants.py.
