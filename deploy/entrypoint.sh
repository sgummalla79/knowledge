...
# *processes* (--workers > 1) would isolate that, but app/application/job_store.py and
# app/rate_limit.py both keep their state in a plain in-memory dict scoped to one process
