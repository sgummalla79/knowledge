...
from app.domain.entities import Query as QueryEntity
from app.infrastructure.orm import Query as QueryModel
from app.infrastructure.orm import QueryResult as QueryResultModel
